/**
 * Hexo server-side helpers for the GitBook landing page.
 *
 * IMPORTANT:
 * - Hexo only auto-loads helper code from:
 *   - <root>/scripts/
 *   - <theme>/scripts/
 * - Files under <theme>/source/js are served to the browser and are NOT executed by Hexo.
 *
 * This file intentionally lives in <theme>/scripts so `get_all_images()` is available in EJS.
 */
var fs = require('fs');
