...
```powershell
Get-DomainUser -Identity mmorgan -Domain blackwood.local | Select-Object -Property name,samaccountname,description,memberof,whencreated,pwdlastset,lastlogontimestamp,accountexpires,admincount,userprincipalname,serviceprincipalname,useraccountcontrol

name                 : Matthew Morgan
samaccountname       : mmorgan
description          :
memberof             : {CN=VPN Users,OU=Security Groups,OU=Corp,DC=BLACKWOOD,DC=LOCAL, CN=Shared Calendar
                       Read,OU=Security Groups,OU=Corp,DC=BLACKWOOD,DC=LOCAL, CN=Printer Access,OU=Security
                       Groups,OU=Corp,DC=BLACKWOOD,DC=LOCAL, CN=File Share H Drive,OU=Security
                       Groups,OU=Corp,DC=BLACKWOOD,DC=LOCAL...}
whencreated          : 10/27/2021 5:37:06 PM
pwdlastset           : 11/18/2021 10:02:57 AM
lastlogontimestamp   : 2/27/2022 6:34:25 PM
accountexpires       : NEVER
admincount           : 1
userprincipalname    : mmorgan@blackwood.local
...
```powershell-session
PS C:\htb> Test-AdminAccess -ComputerName MS01
...
--------------------                          --------------
adfsconnect/azure01.blackwood.local       adfs
backupjob/veam001.blackwood.local         backupagent
d0wngrade/kerberoast.blackwood.local      d0wngrade
kadmin/changepw                               krbtgt
MSSQLSvc/DEV-PRE-SQL.blackwood.local:1433 sqldev
MSSQLSvc/SPSJDB.blackwood.local:1433      sqlprod
```
