...
_Start with fast sweeps (_`_nmap -T4 --top-ports 1000_`_), then expand with full TCP/UDP scans per host based on significance._
## targeted scripts
- `nmap` with targeted scripts: e.g., `--script smb-enum-shares`, `ldap-search`, `snmp-info`
