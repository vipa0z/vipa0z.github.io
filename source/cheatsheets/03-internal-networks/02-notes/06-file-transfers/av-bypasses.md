...
### venom shells that don't get detected

encode + pack with software or archive 2 times/3 times with pass
remove .RAR extension

```title:pack-with-software-+encode-5-times+continue-program
