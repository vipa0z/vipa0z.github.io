---
title: Writing custom wordlists using hashcat and cuppy 
...
```shell-session
magdy3660@htb[/htb]$ hashcat --force password.list -r custom.rule --stdout | sort -u > mut_password.list
```
...
Run `cuppy` in interactive mode and enter the information we gathered about Mark.
```
cuppy -i 
# When prompted, enter the details and save the file as mark.txt
```
