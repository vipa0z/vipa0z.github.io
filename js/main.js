...
$(document).ready(function () {
    ...
    $('figure.highlight').each(function () {
        ...
        var tools = ['python3', 'gobuster', 'ffuf', 'kr', 'python2', 'python', 'netexec', 'impacket-smbserver', 'ffuf', 'sqlmap', 'nmap', 'metasploit', 'burpsuite', 'hashcat', 'hydra', 'aircrack-ng', 'wireshark', 'nikto', 'masscan'];
