...
# With credentials
crackmapexec smb 10.10.10.10 -u 'username' -p 'password' --rid-brute
```
...
# Spider shares
crackmapexec smb 10.10.10.10 -u username -p password -M spider_plus --share 'Share Name'
...
crackmapexec smb 10.10.10.10 -u '' -p '' --rid-brute --shares --users
```
