...
![[Pasted image 20251129233640.png]]

---
## IDOR

querying other users
![[Pasted image 20251129235030.png]]
...
![GraphQL schema diagram with three tables: Query, UserObject, and PostObject. Query includes users, posts, user, postByAuthor, and post. UserObject fields: uuid, id, username, password, role, msg, posts. PostObject fields: uuid, id, title, body, category, authorId, author. Arrows show relationships.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/271/info_5.png)
